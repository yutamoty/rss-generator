...
抽出対象がマンガの話数一覧などで、各話に個別のURLが記載されていない場合は、
"link" にはページ自身のURL ({page_url}) を使用してください。

日付は "2026/07/19" のようなYYYY/MM/DD形式や "2026/06/01発売" のような表記もあります。
可能な限りYYYY-MM-DD形式に正規化してください。不明な場合は空文字にしてください。
